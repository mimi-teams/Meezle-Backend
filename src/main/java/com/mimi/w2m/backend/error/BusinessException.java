...
public class BusinessException extends RuntimeException {
    ...
    public BusinessException(ApiResultCode apiResultCode, String message) {
        super(message);
    ...
    public BusinessException(ApiResultCode apiResultCode, String message, String messageToClient) {
        super(message);
        this.apiResultCode = apiResultCode;
        this.message = message;
    ...
    public BusinessException(ApiResultCode apiResultCode, String message, String messageToClient, Throwable cause) {
        super(message, cause);
        this.apiResultCode = apiResultCode;
        this.message = message;
        this.messageToClient = messageToClient;
